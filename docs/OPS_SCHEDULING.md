...
Task: `pipeline_daily` — single serverless notebook (`databricks/pipeline_daily.py`) using shared `/tmp/aq_pulsegrid` for bronze + Delta (see `databricks.yml`). Redeploy after bundle changes:
